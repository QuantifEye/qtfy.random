...
template <class word_t, size_t words, unsigned rounds, word_t t0 = 0U,
          word_t t1 = 0U>
void run_tests(std::vector<test_case<word_t, words>> cases)
{
  for (auto x : cases)
  {
...
{
  run_tests<uint64_t, 4, 13>({{{0x243f6a8885a308d3, 0x13198a2e03707344,
  ...
  run_tests<uint64_t, 4, 20>({{{0x243f6a8885a308d3, 0x13198a2e03707344,
                                0xa4093822299f31d0, 0x082efa98ec4e6c89},
                               {0x452821e638d01377, 0xbe5466cf34e90c6c,
  ...
  run_tests<uint64_t, 4, 72>({{{0x243f6a8885a308d3, 0x13198a2e03707344,
                                0xa4093822299f31d0, 0x082efa98ec4e6c89},
                               {0x452821e638d01377, 0xbe5466cf34e90c6c,
                                0xbe5466cf34e90c6c, 0xc0ac29b7c97c50dd},
...
{
  run_tests<uint32_t, 2, 13>({{{0x243f6a88, 0x85a308d3},
  ...
  run_tests<uint32_t, 2, 20>({{{0x243f6a88, 0x85a308d3},
                               {0x13198a2e, 0x03707344},
  ...
  run_tests<uint32_t, 2, 32>({{{0x243f6a88, 0x85a308d3},
                               {0x13198a2e, 0x03707344},
