...
using threefry = qtfy::random::threefry_trait<t, w, r>;

void test_threefry_64_4()
{
  test<threefry<uint64_t, 4, 13>>({0x243f6a8885a308d3, 0x13198a2e03707344, 0xa4093822299f31d0, 0x082efa98ec4e6c89},
                                  {0x452821e638d01377, 0xbe5466cf34e90c6c, 0xc0ac29b7c97c50dd, 0x3f84d5b5b5470917},
                                  {0x4361288ef9c1900c, 0x8717291521782833, 0x0d19db18c20cf47e, 0xa0b41d63ac8581e5});
  test<threefry<uint64_t, 4, 13>>({}, {},
                                  {0x4071fabee1dc8e05, 0x02ed3113695c9c62, 0x397311b5b89f9d49, 0xe21292c3258024bc});
  test<threefry<uint64_t, 4, 13>>({UINT64_MAX, UINT64_MAX, UINT64_MAX, UINT64_MAX},
                                  {UINT64_MAX, UINT64_MAX, UINT64_MAX, UINT64_MAX},
                                  {0x7eaed935479722b5, 0x90994358c429f31c, 0x496381083e07a75b, 0x627ed0d746821121});

  test<threefry<uint64_t, 4, 20>>({0x243f6a8885a308d3, 0x13198a2e03707344, 0xa4093822299f31d0, 0x082efa98ec4e6c89},
...
{
  test<threefry<uint64_t, 2, 13>>({0x243f6a8885a308d3, 0x13198a2e03707344}, {0xa4093822299f31d0, 0x082efa98ec4e6c89},
  ...
  test<threefry<uint64_t, 2, 20>>({0x243f6a8885a308d3, 0x13198a2e03707344}, {0xa4093822299f31d0, 0x082efa98ec4e6c89},
  ...
  test<threefry<uint64_t, 2, 32>>({0x243f6a8885a308d3, 0x13198a2e03707344}, {0xa4093822299f31d0, 0x082efa98ec4e6c89},
