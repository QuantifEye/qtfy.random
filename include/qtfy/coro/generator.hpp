#ifndef QUANTIFEYE_GENERATOR_HPP
#define QUANTIFEYE_GENERATOR_HPP
...
// we include it here to support random number generation examples
...
#endif  // QUANTIFEYE_GENERATOR_HPP
