...
auto run_tests(std::vector<test_case<word_t, words>> cases)
{
  for (auto x : cases)
  {
...
{
  run_tests<uint64_t, 4, 7>({{{0x243f6a8885a308d3, 0x13198a2e03707344,
  ...
  run_tests<uint64_t, 4, 10>({{{0x243f6a8885a308d3, 0x13198a2e03707344,
                                0xa4093822299f31d0, 0x082efa98ec4e6c89},
                               {0x452821e638d01377, 0xbe5466cf34e90c6c},
...
{
  run_tests<uint64_t, 2, 7>({{{0x243f6a8885a308d3, 0x13198a2e03707344},
                              {0xa4093822299f31d0},
